...
from suzukitl.errors.rpcerrorlist import ChatSendInlineForbiddenError
from suzukitl.extensions.html import CUSTOM_EMOJIS
from suzukitl.tl.types import Message

from .. import main, utils
from ..types import SuzukiReplyMarkup
...
class Form(InlineUnit):
    async def form(
        ...
        reply_markup: typing.Optional[SuzukiReplyMarkup] = None,
        *,
        force_me: bool = False,
        ...
        :param manual_security: By default, Suzuki will try to inherit inline buttons security from the caller (command)
                                If you want to avoid this, pass `manual_security=True`
        :param disable_security: By default, Suzuki will try to inherit inline buttons security from the caller (command)
        ...
        with contextlib.suppress(AttributeError):
            _suzuki_client_id_logging_tag = copy.copy(self._client.tg_id)  # noqa: F841
                ...
                await inline_query.answer(
                    [
                        InlineQueryResultPhoto(
                            ...
                            thumb_url=(
                                "https://github.com/suzuki-team/assets/raw/master/suzuki-icon.png"
                            ),
                ...
                await inline_query.answer(
                    [
                        InlineQueryResultAudio(
                            ...
                            caption=form.get("text"),
                            parse_mode="HTML",
                            title=form["audio"].get("title", "Suzuki"),
