...
from suzuki_tl.errors.rpcerrorlist import InputUserDeactivatedError, YouBlockedUserError
from suzuki_tl.tl.functions.contacts import UnblockRequest
from suzuki_tl.tl.types import Message
from suzuki_tl.utils import get_display_name
...
class InlineManager(
    ...
    :type client: suzuki.tl_cache.CustomTelegramClient
    :type db: suzuki.database.Database
    :type allmodules: suzuki.loader.Modules
    """
    ...
    def __init__(
        ...
        self._token = db.get("suzuki.inline", "bot_token", False)
    ...
    async def register_manager(
        ...
        self._name = get_display_name(self._client.suzuki_me)
        ...
        try:
            m = await self._client.send_message(self.bot_username, "/start suzuki init")
            ...
            try:
                m = await self._client.send_message(
                    self.bot_username, "/start suzuki init"
                )
            except Exception:
