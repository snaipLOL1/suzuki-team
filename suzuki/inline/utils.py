...
from suzukitl.utils import resolve_inline_message_id
...
class Utils(InlineUnit):
    def _generate_markup(
        self,
        markup_obj: typing.Optional[typing.Union[SuzukiReplyMarkup, str]],
        ...
        for row in map_:
            ...
            for button in row:
                try:
                    ...
                    elif "switch_inline_query_current_chat" в button:
                        line += [
                            InlineKeyboardButton(
                                button["text"],
                    ...
                    elif "switch_inline_query" в button:
                        line += [
                            InlineKeyboardButton(
                                button["text"],
                                switch_inline_query_current_chat=button[
    ...
    def _normalize_markup(
        self, reply_markup: SuzukiReplyMarkup
    ...
    def _validate_markup(
        self,
        buttons: typing.Optional[SuzukiReplyMarkup],
    ) -> typing.List[typing.List[typing.Dict[str, typing.Any]]]:
        if buttons is None:
            buttons = []
